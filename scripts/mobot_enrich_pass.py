...
# ── Research data from Missouri Botanical Garden Plant Finder ──────────────
# Sources:
#   Artemisia schmidtiana  — MOBOT: "small, yellow flowers"
#   Leptinella squalida    — MOBOT: "yellow" (brass buttons)
#   Polemonium reptans     — MOBOT: "light blue, bell-shaped flowers"
#   Thymus pseudolanuginosus — MOBOT: "tiny, tubular, pale pink flowers appear in leaf axils in summer"
#   Yucca filamentosa      — MOBOT: "bell-shaped creamy white flowers on a tall flowering stalk"
#   Microbiota decussata   — MOBOT: non-flowering conifer; no bloom color to record
DATA = {
