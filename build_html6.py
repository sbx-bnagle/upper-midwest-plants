...
button.qbtn{position:fixed;top:20px;right:28px;z-index:101;
...
/* ── Query pane: fixed overlay, presented over the listing ──────────────── */
.query-pane{position:fixed;top:64px;right:28px;z-index:100;
  width:min(320px,calc(100vw - 56px));max-height:calc(100vh - 90px);overflow-y:auto;
...
<div class="query-pane" id="query-pane">
  <h2>Query</h2>
  <div class="qinner">
    <div class="field search-wrap"><label for="q">Search</label>
      <input type="text" id="q" placeholder="Common or botanical name&hellip;"></div>
