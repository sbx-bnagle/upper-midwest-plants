...
# Sources: Missouri Botanical Garden Plant Finder (search result snippets)
# Artemisia schmidtiana: MOBOT — "small, yellow flowers"
# Leptinella squalida:   MOBOT — "button-like yellow flowers appear in early summer"
# Polemonium reptans:    MOBOT — "light blue, bell-shaped flowers"
# Thymus pseudolanuginosus: MOBOT — "tiny, tubular, pale pink flowers appear in summer"
# Yucca filamentosa:     MOBOT — "nodding bell-shaped creamy white flowers"
# Carex pensylvanica/rosea: sedge inflorescences — no explicit garden-attribute color stated
# Microbiota decussata:  non-flowering conifer — no bloom color/time
DATA = {
    'Artemisia schmidtiana':     dict(bc='yellow'),
    'Leptinella squalida':       dict(bc='yellow'),
    'Polemonium reptans':        dict(bc='light blue'),
